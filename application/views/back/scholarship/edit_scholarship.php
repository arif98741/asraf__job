  ...
  <div class="col-10 stretch-card">
  	<div class="card">
       ...
       <!--    <p class="card-description">
        ...
        <?php echo form_open_multipart('admin/scholarship/update_scholarship',array()) ?>
        <div class="form-group row">
        	<label for="exampleInputEmail2" class="col-sm-3 col-form-label">Scholarship Name</label>
        	<div class="col-sm-9">
        		<input type="text" name="scholarship_name" value="<?php echo $scholarship->scholarship_name; ?>" class="form-control" id="exampleInputEmail2" placeholder="Enter scholarship name">
        	</div>
        </div>
        <div class="form-group row">
        	<label for="exampleInputEmail2" class="col-sm-3 col-form-label">Univeristy Name</label>
        	<div class="col-sm-9">
        		<input type="text" name="university_name" value="<?php echo $scholarship->university_name; ?>" class="form-control" id="exampleInputEmail2" placeholder="Enter university_name">
        	</div>
        </div>
        ...
        <div class="form-group row">
        	...
        	<div class="col-sm-9">
        		<input type="date" name="deadline" value="<?php echo $scholarship->deadline; ?>" class="form-control" id="exampleInputEmail2">
        	</div>
        </div>
        ...
        <div class="form-group row">
         ...
         <div class="form-group row">
        	...
        	<div class="col-sm-9">
        		<textarea name="description" id="" cols="30" rows="5" class="form-control" placeholder="Enter scholarship details">
