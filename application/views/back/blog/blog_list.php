                            ...
                            <?php $i = 1; foreach ($blogs as $blog) { ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <a href="<?php echo base_url();?>blog/view/<?php echo $blog->blog_slug;?>/<?php echo $blog->blog_id;?>" target="1" class="btn btn-icon btn-primary">View</a>

                                     <a href="<?php echo base_url();?>admin/blog/edit_blog/<?php echo $blog->blog_id;?>" class="btn btn-icon btn-warning">Edit</a>


                                     <!-- edit end-->

                                     <a href="<?php echo base_url();?>admin/blog/delete_blog/<?php echo $blog->blog_id;?>" class="btn btn-icon btn-danger" onclick="return(confirm('are you sure to delete?'))">Delete</a>
