...
<div id="titlebar">
	<div class="container">
		<div class="ten columns">
			...
			<h2><?php echo $single_category->jobcat_name; ?></h2>
		</div>
	...
	<div class="container">
		...
		<div class="pagination-container">
			<nav class="pagination">
				<ul>
					<?php for($i=1; $i<=$total_no_of_pages; $i++){ ?>
						<li><a href="<?php echo base_url(); ?>seeker/job/browse_jobs_by_category/<?php echo $jobcat_id;  ?>/<?php echo $i; ?>" <?php if($i == $page_id): ?> class="current-page" <?php endif; ?>><?php echo $i; ?></a></li>
					<?php }?>
				</ul>
			</nav>
			...
			<nav class="pagination-next-prev">
				<ul>
					<?php if($page_id != 1): ?>
						<li><a href="<?php echo base_url(); ?>seeker/job/browse_jobs_by_category/<?php echo $jobcat_id;  ?>/<?php echo $i; ?>" class="prev">Previous</a></li>
					<?php endif; ?>

					<?php if($page_id !== $total_no_of_pages): ?>
						<li><a href="<?php echo base_url(); ?>seeker/job/browse_jobs_by_category/<?php echo $jobcat_id;  ?>/<?php echo $next_page; ?>" class="next">Next</a></li>
