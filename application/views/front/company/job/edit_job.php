	...
	<div class="sixteen columns">
		<div class="submit-page">
			...
			<div class="form">
				...
				<input class="search-field" type="text" name="job_title" placeholder="" value="<?php echo $job->job_title; ?>"/>
			...
			<div class="form">
				...
				<input class="search-field" type="text" name="location" placeholder="e.g. London"  value="<?php echo $job->location; ?>"/>
			...
			<div class="form">
				...
				<select name="job_type" data-placeholder="Full-Time" class="chosen-select-no-single">
					...
					<option value="Full-Time" <?php if($job->job_type == 'Full-Time'): ?> selected <?php endif; ?>>Full-Time</option>
					<option value="Part-Time" <?php if($job->job_type == 'Part-Time'): ?> selected <?php endif; ?>>Part-Time</option>
					<option value="Internship" <?php if($job->job_type == 'Internship'): ?> selected <?php endif; ?>>Internship</option>
					<option value="Freelance" <?php if($job->job_type == 'Freelance'): ?> selected <?php endif; ?>>Freelance</option>
				</select>
				...
				<div class="select">
					...
					<select name="jobcat_id" data-placeholder="Choose Categories" class="chosen-select">
						...
						<?php foreach ($jobcats as $jobcat) { ?>
							...
							<option value="<?php echo $jobcat->jobcat_id; ?>"  <?php if($jobcat->jobcat_id == $job->jobcat_id): ?> selected <?php endif; ?>><?php echo $jobcat->jobcat_name; ?></option>
						<?php } ?>
					</select>
				</div>
			</div>
			...
			<div class="form">
				...
				<input class="search-field" type="text" name="salary" placeholder="Salary" value="<?php echo $job->salary; ?>"/>
			...
			<div class="form">
				...
				<textarea class="WYSIWYG" name="job_description" cols="40" rows="3" id="summary" spellcheck="true"><?php echo $job->job_description; ?></textarea>
			...
			<div class="form">
				...
				<input data-role="date" type="text" name="deadline" value="<?php echo $job->deadline; ?>" placeholder="yyyy-mm-dd">
