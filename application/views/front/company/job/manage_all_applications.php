...
<div class="container">
	<h2>You are viewing applications of all jobs<span></h2>
			...
			<?php foreach ($applications as $application) { ?>
					...
					<div class="app-content">
						...
						<div class="info">
							...
							<?php if(!empty($application->image)): ?>
								...
								<span>
									<a href="<?php echo base_url(); ?>seeker/seeker/profile/<?php echo $application->seeker_id; ?>" target="_blank">
										<?php echo $application->application_fullname; ?> </a><br>
										Applied for: <a href="<?php echo base_url(); ?>seeker/job/job_page/<?php echo $application->job_id; ?>"><?php echo $application->job_title; ?></a> </span>
										<ul>
				...
				<div class="pagination-container">
						<nav class="pagination">
							<ul>
								<?php for($i=1; $i<=$total_no_of_pages; $i++){ ?>
									<li><a href="<?php echo base_url(); ?>company/application/manage_all_applications/<?php echo $i; ?>" <?php if($i == $page_id): ?> class="current-page" <?php endif; ?>><?php echo $i; ?></a></li>
								<?php }?>
							</ul>
						</nav>
						...
						<nav class="pagination-next-prev">
							<ul>
								<?php if($page_id != 1): ?>
									<li><a href="<?php echo base_url(); ?>company/application/manage_all_applications/<?php echo $previous_page; ?>" class="prev">Previous</a></li>
								<?php endif; ?>

								<?php if($page_id !== $total_no_of_pages): ?>
									<li><a href="<?php echo base_url(); ?>company/application/manage_all_applications/<?php echo $next_page; ?>" class="next">Next</a></li>
